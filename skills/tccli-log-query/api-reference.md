...
> **CLS 环境配置**：本 skill 支持两个环境，根据 Bug 来源选择（详见 SKILL.md Step 0.5）：
>
> | 配置项 | 生产环境 | 测试环境                                  |
> |--------|---------|---------------------------------------|
...
> | 日志主题 ID | `797014ec-3f76-471b-abd8-a1bba1ec5cfb` | `a73f1503-1abb-4c3d-b53b-ed8f64e7b162` |
>
> **环境选择规则**：工单来源→生产环境，禅道来源→测试环境，直接提供 traceId→必须向用户确认。
>
